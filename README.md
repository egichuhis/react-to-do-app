...
- [📖 To-Do-App-React ](#-to-do-app-react-)
...
# 📖 To-Do-App-React <a name="about-project"></a>

**To-Do-App-React** is a to-do app.
...
```sh
  cd my-folder
  git clone https://github.com/egichuhis/react-to-do-app.git
```
